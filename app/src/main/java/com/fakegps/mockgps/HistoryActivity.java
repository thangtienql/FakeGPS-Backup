...
import static com.fakegps.mockgps.MainActivity.setHistoryLocation;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (!setHistoryLocation(bd09Longitude,bd09Latitude,wgs84Longitude,wgs84Latitude)){
                    DisplayToast("Location failed,Please select the anchor point manually");
                }
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, final View view, int position, long id) {
                new AlertDialog.Builder(HistoryActivity.this)
                        ...
                        .setMessage("Are you sure you want to delete this history?")//这里是中间显示的具体信息
    ...
    private List<Map<String, Object>> fetchAllRecord(SQLiteDatabase sqLiteDatabase, String tableName){
        ...
        try{
            ...
            while (cursor.moveToNext()) {
                ...
                item.put("key_wgslatlng", "[longitude:"+doubleLongitude+" latitude:"+doubleLatitude+"]");
                item.put("kdy_bdlatlng", "[longitude:"+doubleBDLongitude+" latitude:"+doubleBDLatitude+"]");
                data.add(item);
            }
            // 关闭光标
            cursor.close();
